"""LambertZoneII projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/lambert_zone_ii.png
"""
...
fig.text(0.5, 0.035, 'Lambert Zone II — legacy Lambert projection for metropolitan France.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/lambert_zone_ii.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
