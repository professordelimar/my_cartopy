"""InterruptedGoodeHomolosine projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/interrupted_goode_homolosine.png
"""
...
projection = ccrs.InterruptedGoodeHomolosine(emphasis="land")
...
fig.text(0.5, 0.035, 'Interrupted Goode Homolosine — interrupted equal-area world projection.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/interrupted_goode_homolosine.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
