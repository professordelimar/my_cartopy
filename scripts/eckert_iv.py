"""EckertIV projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/eckert_iv.png
"""
...
fig.text(0.5, 0.035, 'Eckert IV — pseudocylindrical equal-area world projection.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/eckert_iv.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
