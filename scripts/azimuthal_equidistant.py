"""AzimuthalEquidistant projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/azimuthal_equidistant.png
"""
...
projection = ccrs.AzimuthalEquidistant(central_longitude=-50, central_latitude=-15)
...
fig.text(0.5, 0.035, 'Azimuthal Equidistant — distances and directions are exact from the center.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/azimuthal_equidistant.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
