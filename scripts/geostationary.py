"""Geostationary projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/geostationary.png
"""
...
projection = ccrs.Geostationary(central_longitude=-60)
...
fig.text(0.5, 0.035, 'Geostationary — satellite view from geostationary orbit.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/geostationary.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
