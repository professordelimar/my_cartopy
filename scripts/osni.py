"""OSNI projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/osni.png
"""
...
fig.text(0.5, 0.035, 'OSNI — Ordnance Survey projection for Northern Ireland.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/osni.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
