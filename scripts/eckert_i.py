"""EckertI projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/eckert_i.png
"""
...
fig.text(0.5, 0.035, 'Eckert I — pseudocylindrical projection with straight meridians and parallels.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/eckert_i.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
