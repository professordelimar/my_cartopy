"""Aitoff projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/aitoff.png
"""
...
fig.text(0.5, 0.035, 'Aitoff — modified azimuthal projection balancing shape and scale.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/aitoff.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
