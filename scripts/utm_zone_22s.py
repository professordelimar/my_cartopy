...
Output: images/utm_zone_22s.png
"""
...
projection = ccrs.UTM(zone=22, southern_hemisphere=True)
fig = plt.figure(figsize=(10.5, 6.4))
ax = plt.axes(projection=projection)
ax.set_extent([-54, -48, -15, 5], crs=ccrs.PlateCarree())
...
fig.text(0.5, 0.035, 'UTM Zone 22S — Universal Transverse Mercator for a South American zone.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/utm_zone_22s.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
