"""EuroPP projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/europp.png
"""
...
ax.set_extent([5, 15, 44, 60], crs=ccrs.PlateCarree())
...
fig.text(0.5, 0.035, 'EuroPP — ED50 / UTM Zone 32N projection used for a European domain.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/europp.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
