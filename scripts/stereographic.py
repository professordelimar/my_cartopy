...
Output: images/stereographic.png
"""
...
projection = ccrs.Stereographic(central_longitude=-50, central_latitude=-15)
fig = plt.figure(figsize=(10.5, 6.4))
ax = plt.axes(projection=projection)
ax.set_extent([-120, 30, -70, 65], crs=ccrs.PlateCarree())
...
fig.text(0.5, 0.035, 'Stereographic — conformal azimuthal projection.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/stereographic.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
