"""Hammer projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/hammer.png
"""
...
fig.text(0.5, 0.035, 'Hammer — modified azimuthal equal-area world projection.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/hammer.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
