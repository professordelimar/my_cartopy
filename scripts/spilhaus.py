"""Spilhaus projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/spilhaus.png
"""

# Spilhaus requires PROJ 9.6 or newer. A conda-forge environment is recommended.
...
projection = ccrs.Spilhaus(rotation=45)
...
fig.text(0.5, 0.035, 'Spilhaus — square world-ocean map emphasizing continuity of the oceans.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/spilhaus.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
