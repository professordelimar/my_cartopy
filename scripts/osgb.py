"""OSGB projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/osgb.png
"""
...
fig.text(0.5, 0.035, 'OSGB — British National Grid projection for Great Britain.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/osgb.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
