"""Miller projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/miller.png
"""
...
fig.text(0.5, 0.035, 'Miller — modified cylindrical projection for world maps.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/miller.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
