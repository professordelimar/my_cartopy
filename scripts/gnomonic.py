...
projection = ccrs.Gnomonic(central_longitude=-40, central_latitude=20)
fig = plt.figure(figsize=(10.5, 6.4))
ax = plt.axes(projection=projection)
ax.set_extent([-90, 10, -30, 70], crs=ccrs.PlateCarree())
...
fig.text(0.5, 0.035, 'Gnomonic — great-circle routes appear as straight lines.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/gnomonic.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
