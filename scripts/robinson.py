...
fig.text(0.5, 0.035, 'Robinson — compromise projection designed for visually balanced world maps.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/robinson.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
