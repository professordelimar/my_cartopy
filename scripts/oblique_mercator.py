"""ObliqueMercator projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/oblique_mercator.png
"""
...
projection = ccrs.ObliqueMercator(central_longitude=-45, central_latitude=-10, azimuth=35)
fig = plt.figure(figsize=(10.5, 6.4))
ax = plt.axes(projection=projection)
ax.set_extent([-120, 40, -70, 70], crs=ccrs.PlateCarree())
...
fig.text(0.5, 0.035, 'Oblique Mercator — Mercator projection along an oblique central line.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/oblique_mercator.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
