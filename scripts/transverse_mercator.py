"""TransverseMercator projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/transverse_mercator.png
"""
...
projection = ccrs.TransverseMercator(central_longitude=-51, central_latitude=0)
fig = plt.figure(figsize=(10.5, 6.4))
ax = plt.axes(projection=projection)
ax.set_extent([-75, -27, -40, 15], crs=ccrs.PlateCarree())
...
fig.text(0.5, 0.035, 'Transverse Mercator — conformal cylindrical projection rotated 90 degrees.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/transverse_mercator.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
