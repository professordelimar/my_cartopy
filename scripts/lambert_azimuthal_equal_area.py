"""LambertAzimuthalEqualArea projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/lambert_azimuthal_equal_area.png
"""
...
projection = ccrs.LambertAzimuthalEqualArea(central_longitude=-55, central_latitude=-15)
...
fig.text(0.5, 0.035, 'Lambert Azimuthal Equal Area — azimuthal equal-area projection.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/lambert_azimuthal_equal_area.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
