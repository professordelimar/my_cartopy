...
fig.text(0.5, 0.035, 'Mercator — conformal cylindrical projection.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/mercator.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
