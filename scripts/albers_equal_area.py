"""AlbersEqualArea projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/albers_equal_area.png
"""
...
projection = ccrs.AlbersEqualArea(central_longitude=-55, central_latitude=-15, standard_parallels=(-5, -42))
...
fig.text(0.5, 0.035, 'Albers Equal Area — conic equal-area projection.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/albers_equal_area.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
