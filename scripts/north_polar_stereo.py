"""NorthPolarStereo projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/north_polar_stereo.png
"""
...
fig.text(0.5, 0.035, 'North Polar Stereo — polar stereographic view of the Northern Hemisphere.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/north_polar_stereo.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
