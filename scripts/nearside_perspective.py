"""NearsidePerspective projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/nearside_perspective.png
"""
...
projection = ccrs.NearsidePerspective(central_longitude=-55, central_latitude=-15)
...
fig.text(0.5, 0.035, 'Nearside Perspective — finite-distance perspective view of the globe.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/nearside_perspective.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
