"""LambertConformal projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/lambert_conformal.png
"""
...
projection = ccrs.LambertConformal(central_longitude=-55, central_latitude=-15, standard_parallels=(-5, -42))
...
fig.text(0.5, 0.035, 'Lambert Conformal — conformal conic projection.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/lambert_conformal.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
