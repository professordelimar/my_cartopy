"""EqualEarth projection example.

Author: Nelson Ribeiro-Filho
Repository: cartopy_projections
Output: images/equal_earth.png
"""
...
fig.text(0.5, 0.035, 'Equal Earth — pseudocylindrical equal-area projection for world maps.', ha="center", va="center", fontsize=12, fontweight="semibold")

plt.savefig('images/equal_earth.png', dpi=400, bbox_inches="tight", pad_inches=0.04, facecolor="white")
plt.show()
